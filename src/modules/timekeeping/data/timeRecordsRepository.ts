...
/**
 * Faltas confirmadas de um único funcionário em um intervalo. Usado sob demanda
 * (ao abrir o modal de férias) para não sobrecarregar o banco na listagem geral.
 * Tenta a consulta em collection group filtrada por funcionário e cai para a
 * leitura por intervalo caso o índice composto ainda não esteja publicado.
 */
